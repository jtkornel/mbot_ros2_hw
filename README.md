...
If you are familiar with ROS2, here are the quick-and-dirty build instructions.
  ...
  ```
  cd $COLCON_WS
  git clone git@github.com:mbot_hardware/mbot_hardware.git src/mbot_hardware
  vcs import src --input src/mbot_hardware/mbot_hardware.<ros-distro>.repos
...
1. Download the required repositories and install package dependencies:
   ...
   cd $COLCON_WS
   git clone git@github.com:mbot_hardware/mbot_hardware.git src/mbot_hardware
   vcs import src --input src/mbot_hardware/mbot_hardware.<ros_distro>.repos
